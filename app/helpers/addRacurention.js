...
const { sortSourceIpv6, sortedIndex, list_to_tree, takeMask, takeAddress, generateList } = require("./validate.js");
...
const checkPrefixes = (prefix, arr, parent ) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        if (veryfing == 1) {
            ...
            prefix.children.splice(sortedIndex(prefix.children, temp_item),0,temp_item)
        }

    }
    prefix.parent = parent;
    prefix.created = true;
    arr.splice(sortedIndex(arr, prefix),0,prefix);
